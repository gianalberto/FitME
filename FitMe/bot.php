...
<body style= "background-image: URL(https://i0.wp.com/www.csscodelab.com/wp-content/uploads/2020/03/html-gradient-background-css.png?resize=300%2C196&ssl=1); background-position: center; background-repeat: no-repeat;background-size: cover;">
    ...
    <section>
        ...
        <div class="row bg-info" style ="border-radius:20px;">
                ...
                <img class="mt-2" src="https://www.pinclipart.com/picdir/big/117-1170236_free-vector-clipart-for-commercial-use.png" class="" style="width:90px; border-radius:50%;"alt="">
                </div>
                <div class="col-6">
                    <p class="display-1 fw-bold text-light">&nbsp;&nbsp;&nbsp;&nbsp;FitME</p>
                </div>
            ...
            <div class="wrapper">
                <div class="form">
                    <div class="bot-inbox inbox ">
                        <div class="row">
                            <div class="col-1">
                                <img class= "mt-2 img-fluid" src="https://www.pinclipart.com/picdir/big/117-1170236_free-vector-clipart-for-commercial-use.png" class="" style="width:50px; margin-left:20px; border-radius:50%;"alt="">
                            </div>
